	...
	<div class="wrapper">
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<%-- userList.pageSize 获取请求传过来的每页显示的个数 --%>
									<a href="${pageContext.request.contextPath}/user/findAll?page=1&&size=${userList.pageSize}" aria-label="Previous">首页</a>
								</li>
									
								<li>
									<%-- userList.pageNum 获取当前页数 --%>
									<a href="${pageContext.request.contextPath}/user/findAll?page=${userList.pageNum-1}&&size=${userList.pageSize}">上一页</a></li>
		...
		<script>
            function changePageSize() {
                ...
                //向服务器发送请求，改变没页显示条数
                location.href = "${pageContext.request.contextPath}/user/findAll?page=${userList.pageNum}&size="
                    + pageSize;
            }
